...
parser.add_argument('-e', action="store_true", help='Interpret PATTERN as an extended regular expression')
parser.add_argument('-v', action="store_true", help='Print debug information while searching')
